    ...
    for (NSInteger defaultRowIndex = 0; defaultRowIndex < 9; defaultRowIndex++) {
        ...
        switch (defaultRowIndex) {
            ...
            case 3:
                ...
                viewControllerFuture = ^UIViewController *{
                    UIViewController *rootViewController = [[ALPHAManager sharedManager].keyWindow rootViewController];
            ...
            case 6:
                ...
                viewControllerFuture = ^UIViewController *{
                    return [FLEXObjectExplorerFactory explorerViewControllerForObject:[ALPHAManager sharedManager].keyWindow];
                };
                break;
