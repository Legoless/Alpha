...
- (id)init
{
    self = [super initWithIdentifier:@"com.unifiedsense.alpha.widget"];
    ...
    if (self)
    {
        ...
        /*FLEXActionItem *closeAction = [FLEXActionItem itemWithIdentifier:@"com.unifiedsense.alpha.close"];
        ...
        FLEXActionItem *infoAction = [FLEXActionItem itemWithIdentifier:@"com.unifiedsense.alpha.info"];
