...
- (ALPHAScreenModel *)screenModelForObject:(ALPHAObjectModel *)object {
   ...
   //
   //
   ALPHATableScreenModel *model =
      [[ALPHATableScreenModel alloc] initWithRequest:object.request];
   ...
   [sections
    addObject:[self sectionForPropertyName:@"properties" inModel:object]];
   ...
   [sections
    addObject:[self sectionForPropertyName:@"classMethods" inModel:object]];
   [sections
    addObject:[self superclassesSectionForModel:object]];
...
- (ALPHAScreenSection *)sectionForPropertyName:(NSString *)property inModel:(ALPHAObjectModel *)model {
   ...
   section.headerText = [[property alpha_titleCaseForCamelCase]
                         stringByAppendingFormat:@" (%ld)", (long)array.count];
   ...
   for (id object in array) {
      ...
      if ([object isKindOfClass:[ALPHAObjectProperty class]]) {
         ...
         item.detail = [ALPHARuntimeUtility
                        descriptionForIvarOrPropertyValue:[(ALPHAObjectProperty *)
                                                           object value]];
      ...
      if (model.objectIsClass &&
          ([object isKindOfClass:[ALPHAObjectProperty class]] ||
           [object isKindOfClass:[ALPHAObjectIvar class]] ||
           ([object isKindOfClass:[ALPHAObjectMethod class]] &&
            ![(ALPHAObjectMethod *)object isClassMethod]))) {
...
- (ALPHAScreenSection *)sectionForObjectTypeWithModel:(ALPHAObjectModel *)model {
   ...
   ALPHAScreenItem *liveInstancesShortcut =
      [self liveInstancesShortcutForClass:NSClassFromString(model.objectClass)];
...
- (ALPHAScreenItem *)liveInstancesShortcutForClass : (Class) class {
   ...
   item.object =
      [ALPHARequest requestWithIdentifier:ALPHAInstanceDataIdentifier
       parameters:@{
          ALPHAInstanceDataClassNameIdentifier :
...
- (ALPHAScreenSection *)sectionForObjectGraphWithObject: (ALPHAObjectModel *)object {
   ...
   item.object = [ALPHARequest
                  requestWithIdentifier:ALPHAInstanceDataIdentifier
                  parameters:@{
                     ALPHAInstanceDataClassNameIdentifier : object.objectClass,
