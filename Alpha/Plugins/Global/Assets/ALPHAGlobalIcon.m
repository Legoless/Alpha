...
NSString *const ALPHAIconGlobalIdentifier = @"com.unifiedsense.alpha.icon.global";

@implementation ALPHAGlobalIcon

- (instancetype)init
{
    self = [super initWithIdentifier:ALPHAIconGlobalIdentifier];
