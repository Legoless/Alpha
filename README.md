...
[![Issues on Waffle](https://img.shields.io/badge/issues%20on-Waffle-blue.svg)](http://waffle.io/legoless/alpha)
...
[![Obj-C Code](https://img.shields.io/badge/code%20in-Objective--C-yellow.svg)](http://github.com/legoless/Alpha)
...
- **Bootstrap** - checks for [KZBootstrap](https://github.com/krzysztofzablocki/KZBootstrap) environments and allows modifying them in real-time (deprecated).
